...
<main class="h-[90vh] flex flex-col justify-center items-center px-4 text-center">
    ...
    <div class="mt-20 mb-20">
        ...
        flex items-center justify-center rounded-full w-40 h-40 
            ...
            <a class="w-40 h-40 
            flex items-center justify-center rounded-full" href="{{ route('planete') }}" alt="Explorer">Explorer</a>           
        </button>
    </div>
</main>
</x-layout_header>
